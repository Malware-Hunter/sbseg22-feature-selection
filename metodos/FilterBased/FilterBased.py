...
def od(permission_id,class_id,ds):
    if b(permission_id,class_id,ds) == 0 or c(permission_id,class_id,ds) == 0:
        return 0.001
...
def acc2(permission_id,class_id,ds):
    if d1(permission_id,ds) == 0 or d2(permission_id,ds) == 0:
        return 0.001
...
def rffs(permission_id,class_id,ds):
    if d1(permission_id,ds) == 0 or d2(permission_id,ds) == 0 or c(permission_id,class_id,ds) == 0:
        return 0.001
