...
def FILTER_FEATURES(ft_names, coef):
  i=0
  n1 = len(coef)
...
for train_index, test_index in kf.split(X):
  ...
  ft_to_delete = FILTER_FEATURES(features_names, coef_in)
...
# X without the 183 features deleted
new_X = X.drop(columns=fold_ft_to_delete[index])
