...
roda_dataset() {
    ...
    echo "python3 -m methods.JOWMDroid.JOWMDroid -d $DATASET -o jowmdroid-$D_NAME --feature-selection-only"
    python3 -m methods.JOWMDroid.JOWMDroid -d $DATASET -o jowmdroid-$D_NAME --feature-selection-only
}
